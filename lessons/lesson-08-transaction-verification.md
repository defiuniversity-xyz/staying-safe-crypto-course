...
### Header Image
**Concept:** Person carefully examining package label before mailing, paralleled with examining wallet transaction prompt
**Style:** Careful verification moment
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Transaction Verification Checklist"
**Content:** Visual checklist: Site legitimate? Action intended? Amount correct? Recipient expected? Approval limited? Understand it?
**Style:** Checklist with checkboxes

### Analogy Illustration
**Concept:** Shipping label verification = transaction prompt verification
**Style:** Side-by-side comparison

### Audio Notes
- Shipping address analogy makes it tangible
- Walk through what different transaction types mean
- Emphasize "when in doubt, reject"
- Duration target: 4-5 minutes

### Video Concept
- Show real wallet prompts and what to look for
- Examples of safe vs. suspicious transactions
- How to reject and research
- Duration: 3 minutes
