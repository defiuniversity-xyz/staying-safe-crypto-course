...
![Summary](https://storage.googleapis.com/staying-safe-crypto-media/images/lesson_01/staying-safe-crypto_01_summary.png)
...
### Header Image
**Concept:** Real Nike store next to identical fake store with slightly wrong signage
**Style:** Spot-the-difference visual
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Spot the Phishing"
**Content:** Real vs. fake URL comparison. Show subtle differences: misspelling, wrong extension, extra characters
**Style:** Before/after comparison

### Analogy Illustration
**Concept:** Fake storefront with stolen branding
**Style:** Security warning feel

### Audio Notes
- Fake store analogy should land immediately
- Give specific URL examples
- Emphasize "no site needs your seed phrase" repeatedly
- Duration target: 4-5 minutes

### Video Concept
- Show real vs. fake site side by side
- Demonstrate what happens when you enter info on fake
- Show how to verify real sites
