...
![Summary](https://storage.googleapis.com/staying-safe-crypto-media/images/lesson_03/staying-safe-crypto_03_summary.png)
...
### Header Image
**Concept:** Storefront with "GRAND OPENING" banner, then same store with "CLOSED" sign and empty interior
**Style:** Before/after scam reveal
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Anatomy of a Rug Pull"
**Content:** 4-step flow: Create Project → Build Hype → Collect Money → Pull Rug (with visuals for each)
**Style:** Timeline with descending value chart

### Analogy Illustration
**Concept:** The overnight disappearing store
**Style:** Empty storefront, for rent sign

### Audio Notes
- Store analogy makes it tangible
- List red flags clearly
- Emphasize that even smart people get rugged
- Duration target: 4-5 minutes

### Video Concept
- Animation of rug pull lifecycle
- Show the hype phase vs. reality
- Red flag checklist
- Duration: 3 minutes
