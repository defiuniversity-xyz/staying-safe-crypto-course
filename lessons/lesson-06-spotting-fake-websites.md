...
### Header Image
**Concept:** Magnifying glass examining URL in browser address bar, spotting subtle difference
**Style:** Detective/verification focus
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Spot the Fake URL"
**Content:** Examples of real vs. fake URLs with differences highlighted. Show: misspelling, extra characters, wrong extension, subdomain tricks
**Style:** Spot-the-difference with answer key

### Analogy Illustration
**Concept:** Double-checking street address before entering a building
**Style:** Careful verification moment

### Audio Notes
- Address verification analogy is intuitive
- Walk through URL anatomy
- Emphasize bookmark habit strongly
- Duration target: 4 minutes

### Video Concept
- Live demonstration of fake vs. real site
- How to read URLs correctly
- Setting up crypto bookmarks folder
