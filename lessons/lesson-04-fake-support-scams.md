...
**"Wallet compromised" DM:**
"We've detected unauthorized access to your wallet. Verify your seed phrase immediately to secure funds." → Scam.

**"Failed transaction" help:**
"I see your transaction failed. Send me the transaction details and seed phrase to help." → Scam.

**"Verification required" email:**
"Your exchange account requires re-verification. Click here and enter your credentials." → Phishing scam.

**"Airdrop claim" assistance:**
"You have unclaimed tokens! I'll help you claim them. First, approve this transaction." → Drainer scam.

**Discord "admin" DM:**
"Hi, I'm an admin. I noticed your issue. Let me help via DM." → Real admins help in public channels.
...
![Summary](https://storage.googleapis.com/staying-safe-crypto-media/images/lesson_04/staying-safe-crypto_04_summary.png)
...
### Header Image
**Concept:** Split image: legitimate call center vs. scammer in hoodie at laptop, both labeled as "support"
**Style:** Real vs. fake contrast
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Real Support vs. Fake Support"
**Content:** Two columns comparing: Who contacts whom, What they ask for, Communication channels, Urgency level
**Style:** Comparison with trust indicators

### Analogy Illustration
**Concept:** Microsoft tech support phone scam → crypto DM scam parallel
**Style:** Old scam meets new platform

### Audio Notes
- Tech support scam analogy is widely known—leverage it
- List the red flags clearly and repeatedly
- Emphasize "seed phrase = always no"
- Duration target: 4 minutes

### Video Concept
- Show fake support DM in action
- Side-by-side comparison with legitimate support flow
