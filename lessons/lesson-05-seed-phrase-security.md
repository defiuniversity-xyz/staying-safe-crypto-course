...
**Core concept:** Your seed phrase is like the combination to a safety deposit box containing everything you own—protect it accordingly.
...
**Physical writing:**
Write it on paper or, better, stamp it on metal. Paper can burn, flood, fade. Metal survives disasters.

**Multiple copies:**
Store copies in different physical locations. One location being destroyed shouldn't mean total loss.

**Secure locations:**
Home safe, bank safe deposit box, trusted family member's safe. Somewhere a thief wouldn't easily find or access.

**No digital traces:**
Don't type it into any device. Don't photograph it. Assume all digital storage is compromised eventually.
...
![Summary](https://storage.googleapis.com/staying-safe-crypto-media/images/lesson_05/staying-safe-crypto_05_summary.png)
...
### Header Image
**Concept:** Safety deposit box with combination dial, showing 12-24 word combination
**Style:** High-security, high-value visual
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Seed Phrase Security Rules"
**Content:** Three columns: NEVER SHARE (list), NEVER STORE DIGITALLY (list), PROPER STORAGE (list)
**Style:** Rules format with icons

### Analogy Illustration
**Concept:** Safety deposit box containing all valuables, combination is the only access
**Style:** Secure vault imagery

### Audio Notes
- Safety deposit box analogy emphasizes value
- List the "nevers" emphatically
- Practical storage suggestions
- Duration target: 4-5 minutes

### Video Concept
- Animation of what seed phrase controls
- Common mistakes and their consequences
- Proper storage demonstration
- Duration: 3 minutes
